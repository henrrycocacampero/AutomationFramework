 ...
 * In the Room <Value> with meeting created, when click on On/Off ScheduleButton, 
...
public class VerifyOptionSendingMailsEnabledWithMeetingOnOffEnabled extends TestBase{
	...
	* Out-Of-Order is Enabled SendMailCheckbox**/
    boolean isEnabledSendMailCheckbox= false; 
	/** errorMessage: It contains the error message that would appear if test case fails*/	  
    ...
    /**
	* This method performs the test case: It verify if enabled the  SendMail Checkbox,
	* when is enabled On/Off ScheduleButton with created meeting.
	*/
	@Test
